...
IdentityFile /users/anantha/.ssh/id_rsa
EOF

echo $s > ~/.ssh/config

# Create necessary gerrit groups
ssh -qp 29418 10.84.13.93 gerrit create-group "'Project Bootstrappers'"
ssh -qp 29418 10.84.13.93 gerrit create-group "'Third-Party CI'"
ssh -qp 29418 10.84.13.93 gerrit create-group "'Voting Third-Party CI'"
ssh -qp 29418 10.84.13.93 gerrit create-group "'Continuous Integration Tools'"
ssh -qp 29418 10.84.13.93 gerrit create-group "'Release Managers'"
ssh -qp 29418 10.84.13.93 gerrit create-group "'Stable Maintainers'"

ssh -qp 29418 10.84.13.93 gerrit ls-groups

# Create opencontrail-project-creator account
cat ~/.ssh/id_rsa.pub | ssh -qp 29418 10.84.13.93 gerrit create-account --group "'Project Bootstrappers'" --group Administrators --full-name "'Project Creator'" --email openstack-infra@lists.opencontrail.org --ssh-key - opencontrail-project-creator
