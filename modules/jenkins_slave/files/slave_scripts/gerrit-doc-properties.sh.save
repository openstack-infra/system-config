...
# The install guide has operating system conditional text so it should get published
# once for each operating system it supports
DOC_OPERATING_SYSTEM=ubuntu
DOC_OPERATING_SYSTEM=centos
...
echo "DOC_OPERATING_SYSTEM=$DOC_OPERATING_SYSTEM" >>gerrit-doc.properties
