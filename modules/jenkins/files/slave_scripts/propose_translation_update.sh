...
change_info=`ssh -p 29418 review.openstack.org gerrit query --current-patch-set status:open project:$ORG/$GIT_REPO topic:transifex/translations owner:jenkins`
