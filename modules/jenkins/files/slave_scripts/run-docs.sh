...
elif [ "$1" == "--conditional-publish" ] ; then
    # If this isn't a tagged release or stable release branch and we only want
    # to publish on the above conditions then delete the build output.
