...
def run_sanity
    ...
    o, exit_code = Sh.run("ssh #{@vms.first.vmname} TEST_RETRY_FACTOR=10.0 TEST_DELAY_FACTOR=1.2 /usr/local/jenkins/slave_scripts/ci-infra/contrail_fab #{@options.fab_tests}", true)
