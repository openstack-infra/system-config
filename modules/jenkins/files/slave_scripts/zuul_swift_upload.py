...
if __name__ == '__main__':
    ...
    result_url = zuul_swift_upload(
        file_path,
        os.environ['ZUUL_EXTRA_SWIFT_URL'],
        os.environ['ZUUL_EXTRA_SWIFT_HMAC_BODY'],
        os.environ['ZUUL_EXTRA_SWIFT_SIGNATURE'],
        os.environ['ZUUL_EXTRA_SWIFT_LOGSERVER_PREFIX'],
        os.environ['ZUUL_EXTRA_SWIFT_DESTINATION_PREFIX']
    )
    print result_url
