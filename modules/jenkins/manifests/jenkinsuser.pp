...
class jenkins::jenkinsuser(
  ...
  # workaround until pypi-mirror can resolve ~jenkins in its config and
  # nodepool can register the correct workspace root with jenkins masters
  if $home != '/home/jenkins' {
    file { '/home/jenkins':
      ensure => link,
      target => $home,
    }
