...
# Jenkins Job module for docs publishers via ftp
# publish:
#   site: 'docs.openstack.org'

import xml.etree.ElementTree as XML

class publisher_docs_ftp(object):
    ...
    def gen_xml(self, xml_parent):
        ...
        XML.SubElement(ftp_transfers, 'remoteDirectory')
        XML.SubElement(ftp_transfers, 'sourceFiles').text = ''
        XML.SubElement(ftp_transfers, 'excludes').text = ''
        XML.SubElement(ftp_transfers, 'removePrefix').text = ''
