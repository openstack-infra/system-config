...
class trigger_gerrit(object):
    ...
    def gen_xml(self, xml_parent):
        ...
        if trigger_data['overrideVotes'] == 'true':
            XML.SubElement(gtrig, 'gerritBuildSuccessfulVerifiedValue').text = trigger_data['gerritBuildSuccessfulVerifiedValue']
            XML.SubElement(gtrig, 'gerritBuildFailedVerifiedValue').text = trigger_data['gerritBuildFailedVerifiedValue']
