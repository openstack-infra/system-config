# == Class: test_project::nodepool_prod
#
class test_project::nodepool_prod(
  $mysql_root_password,
  $mysql_password,
  $nodepool_ssh_private_key = '',
  $nodepool_template = 'test_project/nodepool/nodepool.yaml.erb',
  $nodepool_logging_template = 'test_project/nodepool/nodepool.logging.conf.erb',
  ...
  $project_config_repo = '',
  $clouds_yaml_template = 'test_project/nodepool/clouds.yaml.erb',
) {
