# == Class: test_project::jenkins_dev
#
class test_project::jenkins_dev (
  ...
  class { '::jenkins::master':
    ...
    jenkins_ssh_public_key  => $test_project::jenkins_dev_ssh_key,
  }
...
#  }
  ...
  class { '::nodepool':
    ...
    environment              => {
      'NODEPOOL_SSH_KEY'     => $test_project::jenkins_dev_ssh_key,
    }
  }
  ...
  file { '/etc/nodepool/nodepool.yaml':
    ...
    group   => 'root',
    mode    => '0400',
    content => template("test_project/nodepool/${nodepool_template}"),
    require => [
      File['/etc/nodepool'],
      User['nodepool'],
    ],
  ...
  file { '/etc/nodepool/scripts':
    ...
    source  => 'puppet:///modules/test_project/nodepool/scripts',
  }
