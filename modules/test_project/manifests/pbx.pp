...
class test_project::pbx (
  ...
  class { 'asterisk':
    asterisk_conf_source  => 'puppet:///modules/test_project/pbx/asterisk/asterisk.conf',
    modules_conf_source   => 'puppet:///modules/test_project/pbx/asterisk/modules.conf',
  }
  ...
  file {'/etc/asterisk/sip.conf.d/sip.conf':
    ...
    group   => 'asterisk',
    mode    => '0660',
    content => template('test_project/pbx/asterisk/sip.conf.erb'),
  ...
  file {'/etc/asterisk/extensions.conf.d/extensions.conf':
    ...
    group   => 'asterisk',
    mode    => '0660',
    source  => 'puppet:///modules/test_project/pbx/asterisk/extensions.conf',
    require => File['/etc/asterisk/'],
  }
  ...
  file {'/etc/asterisk/cdr.conf.d/cdr.conf':
    ...
    group   => 'asterisk',
    mode    => '0660',
    source  => 'puppet:///modules/test_project/pbx/asterisk/cdr.conf',
    require => File['/etc/asterisk/'],
  }
  ...
  file {'/etc/asterisk/cdr_custom.conf.d/cdr_custom.conf':
    ...
    group   => 'asterisk',
    mode    => '0660',
    source  => 'puppet:///modules/test_project/pbx/asterisk/cdr_custom.conf',
    require => File['/etc/asterisk/'],
  }
}
