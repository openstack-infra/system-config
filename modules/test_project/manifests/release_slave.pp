...
#
class test_project::release_slave (
  $pypi_password,
  ...
  file { '/home/jenkins/.npmrc':
    ...
    group   => 'jenkins',
    mode    => '0600',
    content => template('test_project/npmrc.erb'),
  ...
  file { '/home/jenkins/.pypirc':
    ...
    group   => 'jenkins',
    mode    => '0600',
    content => template('test_project/pypirc.erb'),
    require => File['/home/jenkins'],
  }
  ...
  file { '/home/jenkins/.jenkinsci-curl':
    ...
    group   => 'jenkins',
    mode    => '0600',
    content => template('test_project/jenkinsci-curl.erb'),
    require => File['/home/jenkins'],
  }
  ...
  file { '/home/jenkins/.mavencentral-curl':
    ...
    group   => 'jenkins',
    mode    => '0600',
    content => template('test_project/mavencentral-curl.erb'),
    require => File['/home/jenkins'],
  }
  ...
  file { '/home/jenkins/.puppetforge.yml':
    ...
    group   => 'jenkins',
    mode    => '0600',
    content => template('test_project/puppetforge.yml.erb'),
    require => File['/home/jenkins'],
  }
