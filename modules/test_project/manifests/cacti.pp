...
class test_project::cacti (
  ...
  file { '/etc/apache2/conf.d/cacti.conf':
    ...
    source  => 'puppet:///modules/test_project/cacti/apache.conf',
    mode    => '0644',
    owner   => 'root',
    group   => 'root',
  ...
  file { '/usr/local/share/cacti/resource/snmp_queries/net-snmp_devio.xml':
    ...
    source  => 'puppet:///modules/test_project/cacti/net-snmp_devio.xml',
    mode    => '0644',
    owner   => 'root',
    group   => 'root',
  ...
  file { '/var/lib/cacti/linux_host.xml':
    ...
    source  => 'puppet:///modules/test_project/cacti/linux_host.xml',
    mode    => '0644',
    owner   => 'root',
    group   => 'root',
    require => File[
  ...
  file { '/usr/local/bin/create_graphs.sh':
    ...
    source => 'puppet:///modules/test_project/cacti/create_graphs.sh',
    mode   => '0744',
    owner  => 'root',
    group  => 'root',
  }
  ...
  test_project::cacti_device { $cacti_hosts: }
}
