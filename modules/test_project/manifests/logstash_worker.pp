...
#
class test_project::logstash_worker (
  ...
  file { '/etc/default/logstash-indexer':
    ...
    group  => 'root',
    mode   => '0644',
    source => 'puppet:///modules/test_project/logstash/logstash-indexer.default',
  }

  class { 'logstash::indexer':
    conf_template => 'test_project/logstash/indexer.conf.erb',
  }

  include log_processor
  log_processor::worker { 'A':
    config_file => 'puppet:///modules/test_project/logstash/jenkins-log-worker.yaml',
  }
