...
class test_project::static (
  ...
  ::httpd::vhost { 'ci.openstack.org':
    ...
    template      => 'test_project/ci.vhost.erb',
  }

  ###########################################################
  # Logs
  class { 'openstackci::logserver':
    jenkins_ssh_key         => $test_project::jenkins_ssh_key,
  ...
  ::httpd::vhost { 'security.openstack.org':
    ...
    priority   => '50',
    ssl        => true,
    template   => 'test_project/security.vhost.erb',
  ...
  ::httpd::vhost { 'summit.openstack.org':
    ...
    priority      => '50',
    docroot       => 'MEANINGLESS_ARGUMENT',
    template      => 'test_project/summit.vhost.erb',
  }
  ...
  ::httpd::vhost { 'devstack.org':
    ...
    template      => 'test_project/devstack.vhost.erb',
  }
  ...
  ::httpd::vhost { 'trystack.openstack.org':
    ...
    template      => 'test_project/trystack.vhost.erb',
