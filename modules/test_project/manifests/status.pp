...
class test_project::status (
  ...
  class { 'jenkins::jenkinsuser':
    ssh_key => $test_project::jenkins_ssh_key,
  ...
  ::httpd::vhost { 'status.openstack.org':
    ...
    template => 'test_project/status.vhost.erb',
  ...
  file { '/srv/static/status/index.html':
    ...
    source  => 'puppet:///modules/test_project/status/index.html',
    require => File['/srv/static/status'],
  }

  file { '/srv/static/status/favicon.ico':
    ensure  => present,
    source  => 'puppet:///modules/test_project/status/favicon.ico',
    require => File['/srv/static/status'],
  }

  file { '/srv/static/status/common.js':
    ensure  => present,
    content => template('test_project/status/common.js.erb'),
    require => File['/srv/static/status'],
    replace => true,
  }
  ...
  file { '/srv/static/status/zuul/index.html':
    ...
    content => template('test_project/zuul/status.html.erb'),
    require => File['/srv/static/status/zuul'],
  }

  file { '/srv/static/status/zuul/status.js':
    ensure  => present,
    content => template('test_project/zuul/status.js.erb'),
    require => File['/srv/static/status/zuul'],
  }

  file { '/srv/static/status/zuul/green.png':
    ensure  => present,
    source  => 'puppet:///modules/test_project/zuul/green.png',
    require => File['/srv/static/status/zuul'],
  }

  file { '/srv/static/status/zuul/red.png':
    ensure  => present,
    source  => 'puppet:///modules/test_project/zuul/red.png',
    require => File['/srv/static/status/zuul'],
  }

  file { '/srv/static/status/zuul/black.png':
    ensure  => present,
    source  => 'puppet:///modules/test_project/zuul/black.png',
    require => File['/srv/static/status/zuul'],
  }

  file { '/srv/static/status/zuul/grey.png':
    ensure  => present,
    source  => 'puppet:///modules/test_project/zuul/grey.png',
    require => File['/srv/static/status/zuul'],
  }

  file { '/srv/static/status/zuul/line-angle.png':
    ensure  => present,
    source  => 'puppet:///modules/test_project/zuul/line-angle.png',
    require => File['/srv/static/status/zuul'],
  }

  file { '/srv/static/status/zuul/line-t.png':
    ensure  => present,
    source  => 'puppet:///modules/test_project/zuul/line-t.png',
    require => File['/srv/static/status/zuul'],
  }

  file { '/srv/static/status/zuul/line.png':
    ensure  => present,
    source  => 'puppet:///modules/test_project/zuul/line.png',
    require => File['/srv/static/status/zuul'],
  }
