...
class test_project::gerrit (
  ...
  class { '::gerrit':
    ...
    enable_melody                       => true,
    melody_session                      => true,
    robots_txt_source                   => 'puppet:///modules/test_project/gerrit/robots.txt',
    ...
    require                             => Class[test_project::server],
  }
  ...
  file { '/home/gerrit2/review_site/static/cla.html':
    ...
    group   => 'root',
    mode    => '0444',
    source  => 'puppet:///modules/test_project/gerrit/cla.html',
    replace => true,
    require => Class['::gerrit'],
  }
  ...
  file { '/home/gerrit2/review_site/static/usg-cla.html':
    ...
    group   => 'root',
    mode    => '0444',
    source  => 'puppet:///modules/test_project/gerrit/usg-cla.html',
    replace => true,
    require => Class['::gerrit'],
  }
  ...
  file { '/home/gerrit2/review_site/static/system-cla.html':
    ...
    group   => 'root',
    mode    => '0444',
    source  => 'puppet:///modules/test_project/gerrit/system-cla.html',
    replace => true,
    require => Class['::gerrit'],
  }
  ...
  file { '/home/gerrit2/review_site/static/title.png':
    ...
    source  => 'puppet:///modules/test_project/openstack.png',
    require => Class['::gerrit'],
  ...
  file { '/home/gerrit2/review_site/static/openstack-page-bkg.jpg':
    ...
    source  => 'puppet:///modules/test_project/openstack-page-bkg.jpg',
    require => Class['::gerrit'],
  }
  ...
  file { '/home/gerrit2/review_site/static/hideci.js':
    ...
    source  => 'puppet:///modules/test_project/gerrit/hideci.js',
    require => Class['::gerrit'],
    notify => Exec['reload_gerrit_header'],
  }
  ...
  file { '/home/gerrit2/review_site/etc/GerritSite.css':
    ...
    source  => 'puppet:///modules/test_project/gerrit/GerritSite.css',
    require => Class['::gerrit'],
  }
  ...
  file { '/home/gerrit2/review_site/etc/GerritSiteHeader.html':
    ...
    source  =>
      'puppet:///modules/test_project/gerrit/GerritSiteHeader.html',
    require => Class['::gerrit'],
  }
  ...
  file { '/home/gerrit2/review_site/hooks/change-merged':
    ...
    group   => 'root',
    mode    => '0555',
    source  => 'puppet:///modules/test_project/gerrit/change-merged',
    replace => true,
    require => Class['::gerrit'],
  }
  ...
  file { '/home/gerrit2/review_site/hooks/change-abandoned':
    ...
    group   => 'root',
    mode    => '0555',
    source  => 'puppet:///modules/test_project/gerrit/change-abandoned',
    replace => true,
    require => Class['::gerrit'],
  }
  ...
  file { '/home/gerrit2/review_site/hooks/patchset-created':
    ...
    group   => 'root',
    mode    => '0555',
    content => template('test_project/gerrit_patchset-created.erb'),
    replace => true,
    require => Class['::gerrit'],
  }
