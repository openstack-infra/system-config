...
class LogRetriever(threading.Thread):
    ...
    def _handle_event(self):
        ...
        if fields['build_status'] not in ['ABORTED', 'CANCELLED']:
            # Handle events ignoring aborted and cancelled builds.
            # These are builds discarded by zuul.
    ...
    def _get_log_data(self, log_address, log_dir, filename):
        ...
        # asynchronously. Make ten attempts to read entire log. Stop
        # when end of file string is reached.
        if self.retry and not gzipped:
