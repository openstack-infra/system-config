...
function header(activeTabName) {
  ...
  tabsName[3] = 'Elastic Recheck'; tabsLink[2] = 'http://status.openstack.org/elastic-recheck/';
  tabsName[4] = 'Release'; tabsLink[3] = 'http://status.openstack.org/release/';
  tabsName[5] = 'Reviews'; tabsLink[4] = 'http://status.openstack.org/reviews/';
  tabsName[6] = 'Bugday'; tabsLink[5] = 'http://status.openstack.org/bugday/';
