...
def mirror_params(item, job, params):
    reusable_node(item, job, params)
    if 'python26' in job.name:
        params['ZUUL_NODE'] = 'mirror26'
    elif 'python27' in job.name:
        params['ZUUL_NODE'] = 'mirror27'
    elif 'python33' in job.name:
        params['ZUUL_NODE'] = 'mirror33'
