...
class openstack_project::review (
  ...
  # https://review-security.openstack.org/Documentation/config-contact.html
  $contactstore_appsec='',
  $contactstore_pubkey='',
  $sysadmins = [],
  # For openstackwatch.
  ...
  class { 'openstack_project::gerrit':
    ...
    email                           => 'review-security@openstack.org',
    ...
    projects_file                   =>
      'openstack_project/review-security.projects.yaml.erb',
