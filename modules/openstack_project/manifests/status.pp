...
class openstack_project::status (
  ...
  file { '/srv/static/status/index.html':
    ...
    content => template('puppet:///modules/openstack_project/status/index.html.erb'),
    require => File['/srv/static/status'],
  }
  ...
  file { '/srv/static/status/common.js':
    ...
    content => template('puppet:///modules/openstack_project/status/common.js.erb'),
    require => File['/srv/static/status'],
  }
  ...
  file { '/srv/static/status/zuul/index.html':
    ...
    content => template('puppet:///modules/openstack_project/zuul/status.html.erb'),
