  ...
  if ($gerrit_configure) {
    ...
    class { 'openstack_project::gerrit':
      ...
      replication                         => [
        ...
        {
          name                 => 'gitea01',
          url                  => 'git@gitea01.opendev.org:222/',
          authGroup            => 'Anonymous Users',
          replicationDelay     => '1',
          replicatePermissions => false,
          mirror               => true,
        ...
        {
          name                 => 'gitea02',
          url                  => 'git@gitea02.opendev.org:222/',
          authGroup            => 'Anonymous Users',
          replicationDelay     => '1',
          replicatePermissions => false,
          mirror               => true,
        ...
        {
          name                 => 'gitea03',
          url                  => 'git@gitea03.opendev.org:222/',
          authGroup            => 'Anonymous Users',
          replicationDelay     => '1',
          replicatePermissions => false,
          mirror               => true,
        ...
        {
          name                 => 'gitea04',
          url                  => 'git@gitea04.opendev.org:222/',
          authGroup            => 'Anonymous Users',
          replicationDelay     => '1',
          replicatePermissions => false,
          mirror               => true,
        ...
        {
          name                 => 'gitea05',
          url                  => 'git@gitea05.opendev.org:222/',
          authGroup            => 'Anonymous Users',
          replicationDelay     => '1',
          replicatePermissions => false,
          mirror               => true,
        ...
        {
          name                 => 'gitea06',
          url                  => 'git@gitea06.opendev.org:222/',
          authGroup            => 'Anonymous Users',
          replicationDelay     => '1',
          replicatePermissions => false,
          mirror               => true,
        ...
        {
          name                 => 'gitea07',
          url                  => 'git@gitea07.opendev.org:222/',
          authGroup            => 'Anonymous Users',
          replicationDelay     => '1',
          replicatePermissions => false,
          mirror               => true,
        ...
        {
          name                 => 'gitea08',
          url                  => 'git@gitea08.opendev.org:222/',
          authGroup            => 'Anonymous Users',
          replicationDelay     => '1',
          replicatePermissions => false,
          mirror               => true,
