    ...
    class { 'openstack_project::gerrit':
      ...
      commentlinks                        => [
        ...
        },
        {
          ...
          html  => '<li class=\"comment_test\"><span class=\"comment_test_name\"><a rel=\"nofollow\">noop</a></span> <span class=\"comment_test_result\"><span class=\"result_SUCCESS\">SUCCESS</span>$1</span></li>',
        },
        {
          name  => 'launchpadbug',
