...
class openstack_project::yum_mirror (
  ...
  # A Fedora 20 x86_64 binary only mirror for testing/updates/release only
  ...
  yum::repo { 'f20-x86_64-release':
    ...
    cron_hour    => 2,
    cron_minute  => 15,
    url_path     => 'fedora/releases/20/Everything/x86_64/os/',
  }

  # A Fedora 20 i386 binary only mirror for testing/updates/release only
  yum::repo { 'f20-i386-updates-testing':
    description => 'Fedora 20 - i386 - Updates Testing',
    mirrorlist  => 'https://mirrors.fedoraproject.org/metalink?repo=updates-testing-f20&arch=i386',
    cron_hour   => 0,
    cron_minute => 15,
    url_path    => 'fedora/updates/testing/20/i386/',
  }

  yum::repo { 'f20-i386-updates':
    description  => 'Fedora 20 - i386 - Updates',
    mirrorlist   => 'https://mirrors.fedoraproject.org/metalink?repo=updates-released-f20&arch=i386',
    cron_hour    => 1,
    cron_minute  => 15,
    url_path     => 'fedora/updates/20/i386/',
  }

  yum::repo { 'f20-i386-release':
    description  => 'Fedora 20 - i386 - Release',
    mirrorlist   => 'https://mirrors.fedoraproject.org/metalink?repo=fedora-20&arch=i386',
    cron_hour    => 2,
    cron_minute  => 15,
    url_path     => 'fedora/releases/20/Everything/i386/os/',
  }
