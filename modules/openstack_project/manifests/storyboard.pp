  ...
  class { 'exim':
    ...
    routers => [
      ...
      {'storyboard' => {
        ...
        'transport'                  => 'storyboard_transport',
      }}
      ],
    transports => [
      ...
      {'storyboard_transport' => {
        'driver'            => 'pipe',
        'command'           => '/path/to/storyboard inject $local_part',
        'current_directory' => '/path/to/storyboard-home',
        'home_directory'    => '/path/to/storyboard-home',
        'user'              => 'storyboard',
        'group'             => 'storyboard',
      }}
      ],
