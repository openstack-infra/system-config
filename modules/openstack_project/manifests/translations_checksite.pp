...
class openstack_project::translations_checksite (
  ...
  $devstack_database_password = 'password',
  $devstack_rabbit_password = 'password',
  $devstack_service_password = 'password',
  $devstack_service_token = 'password',
  $devstack_swift_hash = 'password',
  $devstack_ssh_pubkey = '',
