class openstack_project::infracloud::controller(
  ...
  openstack_project::infracloud::ssl { 'glance':
    key_content  => $glance_ssl_key_file_content,
    cert_content => $glance_ssl_cert_file_content,
  ...
  openstack_project::infracloud::ssl { 'neutron':
    key_content  => $neutron_ssl_key_file_content,
    cert_content => $neutron_ssl_cert_file_content,
  ...
  openstack_project::infracloud::ssl { 'nova':
    key_content  => $nova_ssl_key_file_content,
    cert_content => $nova_ssl_cert_file_content,
