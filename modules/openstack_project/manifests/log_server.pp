# == Class: openstack_project::log-server
#
class openstack_project::log_server (
  $domain = 'mydomain.com',
  $jenkins_ssh_key,
  $sysadmins = [],
  $swift_authurl = '',
  ...
  package { 'keyring':
#    ensure   => 'latest',
# TODO: 'latest' doesn't work when behind a proxy.
#  Manually pin version to work around pip bug
    ensure   => '4.0',
    provider => 'pip',
  }
