...
class openstack_project::tripleo_slave (
  $certname = $openstack_project::single_use_slave::certname,
  $install_users = $openstack_project::single_use_slave::install_users,
  $install_resolv_conf = $openstack_project::single_use_slave::install_resolv_conf,
  ...
  $automatic_upgrades = $openstack_project::single_use_slave::automatic_upgrades,
  ...
  class { 'openstack_project::template':
    ...
    iptables_rules4     =>
      [
        ...
        '-p tcp --dport 27410:27510 -s 192.168.1.0/24 -j ACCEPT',
      ],
  }
}
