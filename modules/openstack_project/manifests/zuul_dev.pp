...
class openstack_project::zuul_dev(
  ...
  class { '::openstackci::nodepool':
    ...
    jenkins_masters               => [],
    split_daemon                  => true,
    bluebox_username              => $bluebox_username,
    bluebox_password              => $bluebox_password,
    bluebox_project               => $bluebox_project,
    ...
    internap_username             => $internap_username,
    internap_password             => $internap_password,
    internap_project              => $internap_project,
    ...
    infracloud_vanilla_username   => $infracloud_vanilla_username,
    infracloud_vanilla_password   => $infracloud_chocolate_password,
    infracloud_vanilla_project    => $infracloud_vanilla_project,
    infracloud_chocolate_username => $infracloud_chocolate_username,
    infracloud_chocolate_password => $infracloud_chocolate_password,
    infracloud_chocolate_project  => $infracloud_chocolate_project,
    osic_cloud1_username          => $osic_cloud1_username,
    osic_cloud1_password          => $osic_cloud1_password,
    osic_cloud1_project           => $osic_cloud1_project,
    ...
    vexxhost_username             => $vexxhost_username,
    vexxhost_password             => $vexxhost_password,
    vexxhost_project              => $vexxhost_project,
    vexxhost_project              => $vexxhost_project,
    datacentred_password          => $datacentred_password,
    datacentred_project           => $datacentred_project,
    citycloud_username            => $citycloud_username,
    citycloud_password            => $citycloud_password,
  }
