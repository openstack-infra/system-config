...
#
class opencontrail_project::logstash (
  $elasticsearch_nodes = [],
  $gearman_workers = [],
  $discover_nodes = ['elasticsearch01.opencontrail.org:9200'],
  ...
  class { 'log_processor::client':
    config_file => 'puppet:///modules/opencontrail_project/logstash/jenkins-log-client.yaml',
