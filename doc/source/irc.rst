...
:Projects:
  ...
  * https://git.openstack.org/openstack-infra/meetbot
  * https://git.openstack.org/openstack-infra/gerritbot
  * https://git.openstack.org/openstack-infra/statusbot
:Bugs:
...
https://git.openstack.org/openstack-infra/meetbot. Manual installation of the Meetbot
