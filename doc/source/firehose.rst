...
We're using Cyrus as an IMAP server in order to consume lpmqtt via
email. The configuration of the admin password account and creation of
the lpmqtt user for Cyrus were completed using the following::
