...
in :cgit_file:`playbooks/roles/install-ansible/files/groups.yaml`. The
...
.. TODO(mordred) I do not believe this paragraph is true anymore. Needs to be
   tested.
...
the Infra cloud controller hosts, put the following in groups.yaml.
