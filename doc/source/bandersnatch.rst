...
:Documentation:
  * https://pypi.org/project/bandersnatch#configuration
:Bugs:
...
build a complete mirror of pypi.org. Cron execs bandersnatch
on an interval with logs going to ``/var/log/bandersnatch``.

Stale Packages
==============

There is an issue with pypi.org syncing to its CDN occasionally
...
bandersnatch logs as::
  ...
  2014-07-11 01:30:04,599 DEBUG: Expected PyPI serial 1154164 for request https://pypi.org/project/python-novaclient/json but got 1154163
...
The fix for this is to issue a PURGE against the url specified above::
  ...
  curl -X PURGE https://pypi.org/project/python-novaclient/json
