...
group: https://review.openstack.org/#/admin/groups/270,members
...
able to vote, the ptl or core-reviewer from the program communicates this decision to the
OpenStack Infrastructure team who will move your Third Party CI System to the Voting
Third-Party CI Gerrit group: https://review.openstack.org/#/admin/groups/91,members
