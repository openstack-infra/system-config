...
* Driver CI systems - these are the most common. This is where your company
  ...
  project as a plugin or extension. In most cases your third-party test system
  may have extra testing requirements imposed by the project your driver has
  integrated with. Examples of this are:
...
* Platform CI systems - The OpenStack Infrastructure project provides CI
  testing for one testing environment. This environment is an x86-based
