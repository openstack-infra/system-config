...
node 'static.openstack.org' {
  ...
  class { 'openstack_project::static':
    ...
    service_types_cert_file_contents  => hiera('service_types_cert_file_contents'),
    service_types_key_file_contents   => hiera('service_types_key_file_contents'),
    service_types_chain_file_contents => hiera('service_types_chain_file_contents'),
  }
}
