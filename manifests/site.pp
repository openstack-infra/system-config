...
node 'nodepool.openstack.org' {
  ...
  $omfracloud_west_username = hiera('nodepool_omfracloud_west_username', 'username')
  $omfracloud_west_password = hiera('nodepool_omfracloud_west_password')
  $omfracloud_west_project  = hiera('nodepool_omfracloud_west_project', 'project')
