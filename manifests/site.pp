...
node 'openstackid.org' {
  class { 'openstack_project::openstackid_prod':
    ...
    id_recaptcha_public_key  => hiera('openstackid_recaptcha_public_key', 'XXX'),
    id_recaptcha_private_key => hiera('openstackid_recaptcha_private_key', 'XXX'),
    app_url                  => 'https://openstackid.org',
    app_key                  => hiera('openstackid_app_key', 'XXX'),
  }
}
...
node 'openstackid-dev.openstack.org' {
  class { 'openstack_project::openstackid_dev':
    ...
    id_recaptcha_public_key  => hiera('openstackid_dev_recaptcha_public_key', 'XXX'),
    id_recaptcha_private_key => hiera('openstackid_dev_recaptcha_private_key', 'XXX'),
    app_url                  => 'https://openstackid-dev.openstack.org',
    app_key                  => hiera('openstackid_dev_app_key', 'XXX'),
  }
}
