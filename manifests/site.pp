...
node /^files\d*\.open.*\.org$/ {
  ...
  class { 'openstack_project::files':
    ...
    review_openstack_cert_file_contents  => hiera('review_openstack_cert_file_contents'),
    review_openstack_key_file_contents   => hiera('review_openstack_key_file_contents'),
    review_openstack_chain_file_contents => hiera('review_openstack_chain_file_contents'),
    require                              => Class['Openstack_project::Server'],
  }
