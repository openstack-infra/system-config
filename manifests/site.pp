...
node 'nodepool.openstack.org' {
  ...
  $rdocloud_username   = hiera('nodepool_rdocloud_username', 'username')
  $rdocloud_password   = hiera('nodepool_rdocloud_password')
  $rdocloud_project    = hiera('nodepool_rdocloud_project', 'project')
