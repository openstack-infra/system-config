...
node /infracloud-controller/ {
  ...
  class { '::openstack_project::infracloud::controller':
    ...
    keystone_ssl_key          => hiera('keystone_ssl_key', $keystone_ssl_key),
    keystone_ssl_cert         => hiera('keystone_ssl_cert', $keystone_ssl_cert),
    keystone_ssl_chain        => hiera('keystone_ssl_chain', $keystone_ssl_chain),
  }
}
