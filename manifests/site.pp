...
node 'nodepool.openstack.org' {
  class { 'openstack_project::nodepool_prod':
    ...
    jenkins_masters          => [
      { name => 'jenkins01', url => 'https://jenkins01.openstack.org/' },
      { name => 'jenkins02', url => 'https://jenkins02.openstack.org/' },
      { name => 'jenkins03', url => 'https://jenkins03.openstack.org/' },
      { name => 'jenkins04', url => 'https://jenkins04.openstack.org/' },
      { name => 'jenkins05', url => 'https://jenkins05.openstack.org/' },
      { name => 'jenkins06', url => 'https://jenkins06.openstack.org/' },
      { name => 'jenkins07', url => 'https://jenkins07.openstack.org/' },
    ],
