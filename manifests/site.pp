...
node 'nodepool.openstack.org' {
  ...
  $infracloud_west_username = hiera('nodepool_infracloud_west_username', 'username')
  $infracloud_west_password = hiera('nodepool_infracloud_west_password')
  $infracloud_west_project  = hiera('nodepool_infracloud_west_project', 'project')
