...
def main():
    ...
    parser = argparse.ArgumentParser(description="When run using OpenStack's "
        "Gerrit server, this builds YAML representations of aggregate change "
        "owner details and change counts for each governance project-team, as "
        "well as a combined set for all teams. Before and after dates/times "
        "should be supplied in formats Gerrit accepts: "
