...
mkdir -p .test
cd .test
[ -d zuul ] || git clone https://git.openstack.org/openstack-infra/zuul.git --depth 1
[ -d jenkins-job-builder ] || git clone https://git.openstack.org/openstack-infra/jenkins-job-builder.git --depth 1
