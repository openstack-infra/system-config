...
if [ -f /usr/bin/yum ]; then
    sudo yum reinstall -y http://people.redhat.com/~iwienand/git/git-1.7.1-3.el6.1.x86_64.rpm http://people.redhat.com/~iwienand/git/perl-Git-1.7.1-3.el6.1.noarch.rpm
fi
