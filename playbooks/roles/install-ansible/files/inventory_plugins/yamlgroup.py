...
DOCUMENTATION = '''
    ...
    options:
      ...
      groups:
        description: |
          dict with group name as key and list of fnmatch patterns.
          If the list item is surrounded by foward slash (/.../) it
          will be considered a regex pattern (i.e. passed to re.match)
        type: dict
        default: {}
'''
EXAMPLES = '''
    ...
    def parse(self, inventory, loader, path, cache=True):
        ...
        for group, hosts in groups.items():
            ...
            for candidate in hosts:
                ...
                # Enclosed in / means it is a regex.  Otherwise it's a
                # fnmatch compatible string; use it's helper to turn
                # that into a regex so we have a common match below.
