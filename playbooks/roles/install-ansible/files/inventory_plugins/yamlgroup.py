    ...
    options:
      ...
      groups:
        description: |
          ...
          If the list item is surrounded by parenthesis () it will be considered
          a regex pattern (i.e. passed to re.match)
        type: dict
        default: {}
'''
EXAMPLES = '''
    ...
    def parse(self, inventory, loader, path, cache=True):
        ...
        for group, hosts in groups.items():
            ...
            for candidate in hosts:
                ...
                # Enclosed in () means it is a regex.  Otherwise it's
                # a fnmatch compatible string; use it's helper to turn
