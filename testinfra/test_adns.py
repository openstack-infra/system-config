...
def test_zone_files(host):
    ...
    assert 'zone "opendev.org" in' in bind_config.content
    assert 'zone "acme.opendev.org" in' in bind_config.content
    assert 'zone "zuul-ci.org" in' in bind_config.content
