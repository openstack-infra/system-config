...
def test_zone_files(host):
    ...
    assert b'zone opendev.org in' in bind_config.content
    assert b'zone acme.opendev.org in' in bind_config.content
    assert b'zone zuul-ci.org in' in bind_config.content
    assert b'zone zuulci.org in' in bind_config.content
