...
# licensed
MODULE_KEYS=( puppetlabs-stdlib puppetlabs-mysql puppetlabs-postgresql
              puppetlabs-apt puppetlabs-apache puppetlabs-rabbitmq
              puppetlabs-haproxy puppetlabs-inifile puppetlabs-firewall
              saz-memcached spiette-selinux rafaelfc-pear openstackci-vcsrepo
              puppetlabs-puppetdb stankevich-python )
